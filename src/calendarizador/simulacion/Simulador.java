...
import java.util.*;
import calendarizador.algoritmos.Calendarizador;
...
public class Simulador
{
    ...
    public Simulador(Calendarizador calendarizador, GestorColas gestorColas, GanttRenderer ganttRenderer)
    {
        this.calendarizador = calendarizador;
        this.gestorColas = gestorColas;
        this.ganttRenderer = ganttRenderer;
        this.current_tick = 0;
    }
    ...
    public void tick()
    {
        ...
        List<PCB> listos = (List<PCB>) gestorColas.getListos();
